...
-- Versão 6 - Usando INTERNAL_WEBHOOK_SECRET para autenticação interna
-- Data: 15/11/2025
...
BEGIN
  ...
  IF internal_secret IS NULL THEN
    ...
    EXCEPTION WHEN OTHERS THEN
      internal_secret := 'INTERNAL_SECRET_PLACEHOLDER';
    END;
  END IF;
